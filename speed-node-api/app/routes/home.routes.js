...
module.exports = function(app) {
  ...
  app.get("/api/home/offer/image9/get",[authJwt.verifyToken], controller.getSingleOfferImage9);
  app.post('/api/home/offer/image9',   [authJwt.verifyToken, authJwt.isAdmin], controller.createOfferImage9);
  app.put('/api/home/offer/image9/:id', [authJwt.verifyToken, authJwt.isAdmin], controller.updateOfferImage9);
