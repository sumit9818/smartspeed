...
export class ImageThreeComponent implements OnInit {
	...
	constructor(
  	...
  	ngOnInit() {
		this.HomePageService.getOffer3().pipe(first()).subscribe(offer2 => {this.offer2 = offer2})
		// functions   
	...
	private updateBannerValue(): void {
		this.HomePageService.getOffer3().subscribe(
	...
	private createOffer2() {
		this.HomePageService.AddOffer3(this.form.value).pipe(first()).subscribe(
		data => {
