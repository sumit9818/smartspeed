...
export class ImageFourComponent implements OnInit {
	...
	constructor(
  	...
  	ngOnInit() {
		this.HomePageService.getOffer2().pipe(first()).subscribe(offer2 => {this.offer2 = offer2})
		// functions   
	...
	private updateBannerValue(): void {
		this.HomePageService.getOffer4().subscribe(
	...
	private createOffer2() {
		this.HomePageService.AddOffer4(this.form.value).pipe(first()).subscribe(
		data => {
