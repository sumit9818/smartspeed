...
export class ImageFiveComponent implements OnInit {
	...
	constructor(
  	...
  	ngOnInit() {
		this.HomePageService.getOffer5().pipe(first()).subscribe(offer2 => {this.offer2 = offer2})
		// functions   
	...
	private updateBannerValue(): void {
		this.HomePageService.getOffer5().subscribe(
	...
	private createOffer2() {
		this.HomePageService.AddOffer5(this.form.value).pipe(first()).subscribe(
		data => {
