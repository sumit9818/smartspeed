...
export class ImageSixComponent implements OnInit {
	...
	constructor(
  	...
  	ngOnInit() {
		this.HomePageService.getOffer6().pipe(first()).subscribe(offer2 => {this.offer2 = offer2})
		// functions   
	...
	private updateBannerValue(): void {
		this.HomePageService.getOffer6().subscribe(
	...
	private createOffer2() {
		this.HomePageService.AddOffer6(this.form.value).pipe(first()).subscribe(
		data => {
